...
<body>
			...
			<div class="md:w-1/3 justify-center md:inline-block flex md:flex-nowrap flex-wrap items-center">
				...
				@if($user['level'] == "Senior")
					...
					<strong class="text-nobel block leading-none md:text-xl text-lg">
						<img src="{{ URL::asset('images/certificaciones/empresarial/senior.png') }}" style="margin-left: 8px;
    width: 224px;" alt="Advanced Hipotecario" />
				...
				<div class="block" style="width: 13rem">
					<strong class="text-nobel block leading-none md:text-xl text-lg">
						<img src="{{ URL::asset('images/certificaciones/empresarial/advanced.png') }}" style="margin-left: 8px;
    width: 224px;" alt="Advanced Hipotecario" />
					</strong>
				</div>
				...
				<div class="block" style="width: 13rem">
					<strong class="text-nobel block leading-none md:text-xl text-lg">
						<img src="{{ URL::asset('images/certificaciones/empresarial/master.png') }}" style="margin-left: 8px;
    width: 224px;" alt="Advanced Hipotecario" />
					</strong>
				</div>
				@else
		...
		<section class="my-16">
			<div class="grid md:grid-cols-1 md:gap-14 gap-8 mx-auto max-w-2xl">
				...
				<div class="px-4 md:py-4 py-8 rounded-lg bg-white-smoke flex items-center justify-center flex-col">
					...
					<a href="https://socasesores.com/micrositios-empresarial/{{ $office['url'] }}" class="link-oficina leading-none py-2 mt-2">Visita nuestra oficina</a>
				</div>
				@endif
